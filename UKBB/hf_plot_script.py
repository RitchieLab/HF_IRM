...
for index, col in enumerate(eval_col_list, start = 1):
    ...
    if len(model_df.index) == 0:
        ...
        col = col.replace("]", "")
        col = col.replace(",", " +")
        col = col.replace("PGS + T2D + LDL_INV_NORMAL_SCALE + HDL_INV_NORMAL_SCALE + GLUCOSE_INV_NORMAL_SCALE + SBP_INV_NORMAL_SCALE + BMI_INV_NORMAL_SCALE + PA_EVERYDAY_SCALE + NEIGHBORHOOD_BIKE_SCALE + NEIGHBORHOOD_GET_ALONG_SCALE + NEIGHBORHOOD_UNSAFE_WALK_SCALE + NEIGHBORHOOD_CRIME_WALK_SCALE + NEIGHBORHOOD_FREE_AMENITIES_SCALE + INCOME_SCALE + SOCIAL_DEPRIVATION_INDEX_INV_NORMAL_SCALE",
                              "PGS + CRS Risk Factors + PXS Risk Factors")
        col = col.replace("T2D + LDL_INV_NORMAL_SCALE + HDL_INV_NORMAL_SCALE + GLUCOSE_INV_NORMAL_SCALE + SBP_INV_NORMAL_SCALE + BMI_INV_NORMAL_SCALE + PA_EVERYDAY_SCALE + NEIGHBORHOOD_BIKE_SCALE + NEIGHBORHOOD_GET_ALONG_SCALE + NEIGHBORHOOD_UNSAFE_WALK_SCALE + NEIGHBORHOOD_CRIME_WALK_SCALE + NEIGHBORHOOD_FREE_AMENITIES_SCALE + INCOME_SCALE + SOCIAL_DEPRIVATION_INDEX_INV_NORMAL_SCALE",
                              "CRS Risk Factors + PXS Risk Factors")
        col = col.replace("T2D + LDL_INV_NORMAL_SCALE + HDL_INV_NORMAL_SCALE + GLUCOSE_INV_NORMAL_SCALE + SBP_INV_NORMAL_SCALE",
                              "CRS Risk Factors")
        col = col.replace("BMI_INV_NORMAL_SCALE + PA_EVERYDAY_SCALE + NEIGHBORHOOD_BIKE_SCALE + NEIGHBORHOOD_GET_ALONG_SCALE + NEIGHBORHOOD_UNSAFE_WALK_SCALE + NEIGHBORHOOD_CRIME_WALK_SCALE + NEIGHBORHOOD_FREE_AMENITIES_SCALE + INCOME_SCALE + SOCIAL_DEPRIVATION_INDEX_INV_NORMAL_SCALE",
                              "PXS Risk Factors")
