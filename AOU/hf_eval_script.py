...
# export dfs
auroc_df.to_csv((output_dir + 'AUROC_' + colname + '.txt'), sep = '\t')
auprc_df.to_csv((output_dir + 'AUPRC_' + colname + '.txt'), sep = '\t')
f1_df.to_csv((output_dir + 'F1_SCORE_' + colname + '.txt'), sep = '\t')
balanced_acc_df.to_csv((output_dir + 'BALANCED_ACCURACY_' + colname + '.txt'), sep = '\t')
